...
def convert_to_sarif(input_file, output_file, commit_hash):
    ...
    Final approach:
      ...
      - shortDescription = "<pkg_name>==<pkg_version> - Alert generated by Socket Security"
      - fullDescription = props["note"]
      - result.message.text = "<title> - <description>"
    """
    ...
    for idx, alert in enumerate(alerts, start=1):
        ...
        short_desc = f"{title} - Alert generated by Socket Security"
        full_desc = note_text
